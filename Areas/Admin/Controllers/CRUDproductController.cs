...
namespace ShopOnline.Areas.Admin.Controllers
{
    ...
    public class CRUDproductController : Controller
    {
        ...
        public ActionResult Create(Product product, HttpPostedFileBase uploadFile)
        {
                        ...
                        else
                        {
                            ...
                            else
                            {
                                ...
                                if (db.SaveChanges() > 0)
                                {
                                    ...
                                    ModelState.Clear();
                                    TempData["msgCreate"] = "Tạo thành công sản phẩm mới!";
            ...
            {
                TempData["msgCreatefailed"] = "Tạo thất bại! " + ex.Message;
        ...
        public ActionResult Edit(Product product, HttpPostedFileBase uploadFile, FormCollection collection)
        {
            try
            {
                ...
                if (ModelState.IsValid)
                {
                    if (uploadFile != null)
                    {
                        ...
                        if (db.SaveChanges() > 0)
                        {
                            TempData["msgEdit"] = "Sửa sản phẩm thành công " + product.productName;
                            uploadFile.SaveAs(path);
                    ...
                    else
                    {
                        ...
                        if (db.SaveChanges() > 0)
                        {
                            TempData["msgEdit"] = "Sản phẩm sửa thành công có ID: " + product.productId;
                            return RedirectToAction("index");
                        }
                    }
                }
            ...
            {
                TempData["msgEditFailed"] = "Sửa thất bại! " + ex.Message;
                return RedirectToAction("Index");
            }
        }
        ...
        public ActionResult Delete(int? id)
        {
            try
            {
                ...
                {
                    TempData["msgDelete"] = "Không thể xóa cái này!";
                    return RedirectToAction("Index");
                }
                else
                {
            ...
            {
                TempData["msgDelete"] = "Không thể xóa cái này! " + ex.Message;
                return RedirectToAction("Index");
            }
        }
